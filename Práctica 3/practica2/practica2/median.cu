...
/// Dispositivos e Infraestructuras para Sistemas Multimedia 2016-2018
...
int main(int argc, char *argv[])
{
	...
	unsigned char *d_input, *d_output, *d_edge, *tmp, *aux;
	...
	// Aplicamos el filtro mediana un número determinado de iteraciones.			//  1.880960s
	for (i = 0; i < ITERATIONS; ++i) 
	{
		/*
		// Ejecución kernel 1D por filas											//  1.843715s
